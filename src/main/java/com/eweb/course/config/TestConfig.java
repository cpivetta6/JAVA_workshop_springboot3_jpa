...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2023-10-02T19:54:07Z"), u1);
		Order o2 = new Order(null, Instant.parse("2021-10-05T19:54:07Z"), u2);
		Order o3 = new Order(null, Instant.parse("2024-12-02T19:54:07Z"), u1);
